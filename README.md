...
- **[`docs/SYSTEM_SINGLE_PACKAGE.md`](docs/SYSTEM_SINGLE_PACKAGE.md)** — a single-module system design to run the real 753B GLM-5.2-FP8 (FP8 compute die + 64 GB GDDR6 + 1 TB Flash, e.g. a USB-C external accelerator): memory tiering, MoE expert caching/streaming, the bottleneck/perf/cost model, and how the committed RTL is the compute die.
